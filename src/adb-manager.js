...
const openLink = (device, link) =>
  new Promise((resolve, reject) => {
    const command = makeAdbCommand(
      device,
      `shell am start -W -a android.intent.action.VIEW -d ${link}`
    );
...
const listPackages = (device, package) =>
  new Promise((resolve, reject) => {
    const command = makeAdbCommand(
      device,
      `shell pm list packages -3 | grep ${package}`
    );
    exec(command, (error, stdout, stderr) => {
      if (error) {
        reject(error);
...
const clearData = (device, package) =>
  new Promise((resolve, reject) => {
...
const uninstallPackage = (device, package) =>
  new Promise((resolve, reject) => {
...
const installApk = (device, apkFile) =>
  new Promise((resolve, reject) => {
